...
CREATE TABLE IF NOT EXISTS `gym_argente`.`clients` (
  ...
  `heures_specialistes` SMALLINT NOT NULL DEFAULT 0,
  `heures_specialistes_utilise` SMALLINT NOT NULL DEFAULT 0,
  `cours_groupe_semaine` TINYINT NOT NULL DEFAULT 0,
  `plan` INT NULL,
  PRIMARY KEY (`personne`),
  UNIQUE INDEX `personne_UNIQUE` (`personne` ASC) VISIBLE,

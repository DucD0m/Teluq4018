              ...
              <div class="modif-plan">
                <form action="#" method="post">
                  <select id="plan-choix" name="plan-choix">
                    ...
                    ?>
                      <option value="<?php echo $plan_id; ?>"><?php echo $plan_nom; ?> (<?php if($plan_prix > 0) echo $plan_prix."$ | "; ?>1 cours de groupe/sem: <?php if($plan_prix_cours_groupe > 0) echo $plan_prix_cours_groupe; ?>$)</option>
                    <?php } ?>
